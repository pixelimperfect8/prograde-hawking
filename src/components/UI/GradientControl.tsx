...
<button
    onClick={() => {
        ...
        // Set params based on current state (accessed via store)
        // Since we're in a component, we use the store hook directly.
        // We need to construct the URL manually or update params.
        // Let's use the simplest approach: construct search params.
        ...
        params.set('embed', 'true') // Crucial for embedding
